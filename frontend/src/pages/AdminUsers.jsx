...
export default function AdminUsers() {
  ...
  const handleSubmitUser = async (e) => {
    ...
    try {
      ...
      setMessage(`✅ Пользователь "${form.full_name}" создан! Данные для входа готовы.`);
  ...
  const copyPasswords = () => {
    ...
    navigator.clipboard.writeText(text).then(() => {
      ...
      // Если не получилось через clipboard, показываем текст
  ...
  return (
    <div className="page-background">
      ...
      <div className="container-page">
        ...
        {/* ===== ОКНО С ПАРОЛЯМИ (ПОСЛЕ СОЗДАНИЯ) ===== */}
